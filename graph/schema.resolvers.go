...
import (
	...
	"github.com/davidAg9/go-graphql/database"
...
func (r *mutationResolver) CreateNewDog(ctx context.Context, input *model.NewDog) (*model.Dog, error) {
